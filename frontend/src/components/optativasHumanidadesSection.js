...
export const OptativasHumanidadesSection = () => {
    const semestersData = data.elective_humanity;
    ...
    return (
        <div style={{
            ...
            <div style={{
                ...
                <Title color="black" fontSize="24px" title="Humanidades" />
            ...
            <div style={{
                ...
                {semestersData.map((subject) => (
                    <SubjectIcon key={subject.code} color="#FFD600" subjectCode={subject.code} subjectName={subject.name} />
                ))}
            </div>
        </div>
    );
